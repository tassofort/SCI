...
namespace SCI.ObjetosDB.Mapeamentos
{
    public class LivroMapping : IEntityTypeConfiguration<Livro>
    {
        public void Configure(EntityTypeBuilder<Livro> builder)
        {
            ...
            builder.Property(c => c.NPaginas).HasColumnType("SMARLLINT");
            builder.Property(c => c.Edicao).HasColumnType("SMARLLINT");
            builder.Property(c => c.Ano).HasColumnType("SMARLLINT");
